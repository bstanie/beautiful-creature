...
MONGODB_GOOGLE_TRENDS_COLLECTION_HOUR = "google_trends_by_hour"
MONGODB_GOOGLE_TRENDS_COLLECTION_DAY = "google_trends_by_day"
MONGODB_REDDIT_COLLECTION = "reddit_data"
